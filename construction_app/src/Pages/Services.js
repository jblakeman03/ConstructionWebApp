        ...
        <div className="servicesContainer">
          ...
          <div className="servicesRow">
            <div className="servicesColumn">
              ...
              <p>
                {" "}
                Whether you need a small extension to an existing deck or a
                brand new multi story deck with a roof, we can meet all your
                decking needs.
              </p>
            </div>
            <div className="servicesColumn">
            ...
            <div className="servicesColumn">
              ...
              <p>
                ...
                pets, or woven wire livestock fence, we have you covered! We
                build most all styles of fencing to accomplish all your fencing
                goals.{" "}
              </p>
            </div>
          </div>
